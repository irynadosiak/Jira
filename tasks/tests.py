...
class TaskModelTests(TestCase):
    ...
    def test_task_status_change_creates_activity(self):
        ...
        task = Task.objects.create(title="Test Task", reporter=self.user, status="todo")
        ...
        self.assertIn("Status changed", str(latest_activity.description))
...
class TaskWebInterfaceTests(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            username="webuser", email="web@example.com", password="testpass123"
        )
